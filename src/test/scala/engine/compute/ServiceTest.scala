...
object ServiceTest:
  ...
  def sampleService(forType: String): Service =
    forType match
      ...
      case "vdi" =>  Service("Custom", "Sample VDI", forType, FAILOVER)
      case "web" =>  Service("Custom", "Sample Web Server", forType, ROUNDROBIN)
      case "portal" =>  Service("Custom", "Sample Portal", forType, FAILOVER)
      case "dbms" =>  Service("Custom", "Sample DBMS", forType, FAILOVER)
      case "relational" =>  Service("Custom", "Sample Relational DS", forType, FAILOVER)
      case "object" =>  Service("Custom", "Sample Object DS", forType, FAILOVER)
      case "stbds" =>  Service("Custom", "Sample ST BDS", forType, ROUNDROBIN)
      case "file" =>  Service("Custom", "Sample File", forType, FAILOVER)
